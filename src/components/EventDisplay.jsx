...
import EventDetailedDescription from "./EventDetailedDescription.jsx";

function EventDisplay({currentEventId, refreshCounter}){
    ...
    return (<>{ currentEvent ? (<div>
        ...
        <EventDetailedDescription currentEvent={currentEvent} />
